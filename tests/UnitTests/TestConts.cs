...
namespace U2F.Core.UnitTests
{
    public static class TestConts
    {
        ...
        public static byte[] KEY_HANDLE_BASE64_BYTE = KEY_HANDLE_BASE64.Base64StringToByteArray();


        public static byte[] USER_PUBLIC_KEY_AUTHENTICATE_HEX = "BNNo8bZlut48M6IPHkKcd1DVAzZgwBkRnSmqS6erwEqnyApGu-EcqMtWdNdPMfipA_a60QX7ardK7-9NuLACXh0".Base64StringToByteArray();
